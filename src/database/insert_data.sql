...
VALUES (1, '../public/1/announce/salade.png', 'Smartphone', 'Brand new smartphone with the latest features', 499.99, 10, 4, 0),
       (2, '../public/1/announce/salade.png', 'T-shirt', 'Casual cotton t-shirt available in multiple colors', 19.99, 50, 5, 0),
       (3, '../public/1/announce/salade.png', 'Novel', 'Best-selling novel by a renowned author', 29.99, 20, 4, 0),
       (1, '../public/1/announce/salade.png', 'Laptop', 'High-performance laptop for work and entertainment', 899.99, 5, 5, 1),
       (2, '../public/1/announce/salade.png', 'Jeans', 'Classic denim jeans for everyday wear', 39.99, 30, 4, 0),
       (3, '../public/1/announce/salade.png', 'Biography', 'Inspirational biography of a famous personality', 24.99, 15, 3, 0),
       (1, '../public/1/announce/salade.png', 'Tablet', 'Sleek and lightweight tablet for on-the-go use', 299.99, 8, 4, 0),
       (2, '../public/1/announce/salade.png', 'Dress', 'Elegant dress for special occasions', 49.99, 25, 5, 0),
       (3, '../public/1/announce/salade.png', 'Self-Help', 'Practical guide to personal development and growth', 19.99, 10, 4, 0),
       (1, '../public/1/announce/salade.png', 'Headphones', 'Wireless headphones with noise-cancelling technology', 99.99, 15, 4, 0),
       (2, '../public/1/announce/salade.png', 'Sweater', 'Warm and cozy sweater for cold weather', 29.99, 35, 5, 0),
       (3, '../public/1/announce/salade.png', 'Mystery', 'Thrilling mystery novel with unexpected twists', 14.99, 12, 4, 0),
       (1, '../public/1/announce/salade.png', 'Smartwatch', 'Smartwatch with fitness tracking and notifications', 149.99, 20, 4, 0),
       (2, '../public/1/announce/salade.png', 'Jacket', 'Stylish jacket for a fashionable look', 59.99, 40, 5, 0),
       (3, '../public/1/announce/salade.png', 'Science Fiction', 'Imaginative science fiction novel set in a futuristic world', 17.99, 8, 4, 0);
